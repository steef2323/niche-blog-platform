...
export async function middleware(request: NextRequest) {
  ...
  // TEMPORARILY DISABLED: Airtable imports cause Edge Runtime issues in Vercel
  // TODO: Implement site detection using a different approach for Edge Runtime
  ...
  // Temporarily disabled site detection for deployment
  // if (site) {
