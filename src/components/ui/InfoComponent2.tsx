...
export default function InfoComponent2({ title, text, image, className = '' }: InfoComponent2Props) {
  ...
  return (
    ...
    >
      ...
      {/* Desktop Layout: 50% columns - Image on left, title + text on right */}
      <div className="hidden md:grid md:grid-cols-2 md:h-full">
        {/* Left Column: Image - no padding from border */}
        ...
        {/* Right Column: Title and Text with 20px padding */}
